...
export KUBERNETES_BINARIES_VERSION=${KUBERNETES_BINARIES_VERSION:-"v1.19.3"}
export UPGRADED_K8S_VERSION_1=${UPGRADED_K8S_VERSION_1:-"v1.19.4"}
export UPGRADED_K8S_VERSION_2=${UPGRADED_K8S_VERSION_2:-"v1.19.4"}
export UPGRADED_BINARY_VERSION=${UPGRADED_BINARY_VERSION:-"v1.19.4"}
