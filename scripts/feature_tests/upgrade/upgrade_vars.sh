...
export CAPIRELEASE_HARDCODED="v0.3.19"
...
export CAPM3RELEASE="v0.4.3"
CAPM3_REL_TO_VERSION="v0.5.3" || true
...
export CAPIRELEASE="v0.3.19"
CAPI_REL_TO_VERSION="v0.4.4" || true
