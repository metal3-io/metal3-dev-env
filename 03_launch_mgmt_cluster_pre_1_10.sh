...
launch_ironic_standalone_operator()
{
    ...
    echo 'IPA_BASEURI=http://10.20.0.4/' > "${IRSOPATH}/config/manager/manager.env"
...
FAKE_IPA_CERTFILE = "${FAKE_IPA_CERTFILE:-/root/sushy/cert.pem}"
FAKE_IPA_KEYFILE = "${FAKE_IPA_KEYFILE:-/root/sushy/key.pem}"
EOF
