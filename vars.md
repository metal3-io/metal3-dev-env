...
3. The Docker engine depends on containerd 1.7. To configure image registries
...
4. You need to replace the default IPv4 addresses with IPv6 addresses in the
   environment variables.
