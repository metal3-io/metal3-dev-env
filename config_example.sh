...
#export UPGRADED_K8S_VERSION="v1.36.0"
...
#
#export IMAGE_NAME="CENTOS_10_NODE_IMAGE_K8S_v1.36.0.qcow2"

# Location of the image to download
#
#export IMAGE_LOCATION="https://artifactory.nordix.org/artifactory/metal3/images/k8s_v1.36.0"
...
# Set nodeDrainTimeoutSeconds for controlplane and worker template, otherwise default value will be  '0'.
#
...
# Ironic is always deployed in-cluster using ironic-standalone-operator (USE_IRSO=true).
