...
#export UPGRADED_K8S_VERSION="v1.26.4"
...
#
#export IMAGE_NAME="CENTOS_9_NODE_IMAGE_K8S_v1.26.4.qcow2"

# Location of the image to download
#
#export IMAGE_LOCATION="https://artifactory.nordix.org/artifactory/metal3/images/k8s_v1.26.4"
