...
#export KUBERNETES_VERSION="v1.23.2"
...
#
#export IMAGE_NAME="CENTOS_8_NODE_IMAGE_K8S_v1.23.2.qcow2"

# Location of the image to download
#
#export IMAGE_LOCATION="https://artifactory.nordix.org/artifactory/airship/images/k8s_v1.23.2"
