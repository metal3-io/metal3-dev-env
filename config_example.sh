...
#
#export IMAGE_NAME="CENTOS_9_NODE_IMAGE_K8S_v1.33.0.qcow2"

# Location of the image to download
#
#export IMAGE_LOCATION="https://artifactory.nordix.org/artifactory/metal3/images/k8s_v1.33.0"
...
# Set nodeDrainTimeoutSeconds for controlplane and worker template, otherwise default value will be  '0s'.
#
