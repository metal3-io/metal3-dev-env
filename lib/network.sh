...
export DEPLOY_KERNEL_URL=${DEPLOY_KERNEL_URL:-"http://172.22.0.1:6180/images/ironic-python-agent.kernel"}
export DEPLOY_RAMDISK_URL=${DEPLOY_RAMDISK_URL:-"http://172.22.0.1:6180/images/ironic-python-agent.initramfs"}
export IRONIC_URL=${IRONIC_URL:-"http://172.22.0.1:6385/v1/"}
export IRONIC_INSPECTOR_URL=${IRONIC_INSPECTOR_URL:-"http://172.22.0.1:5050/v1/"}