...
if [[ "${CAPM3RELEASEBRANCH}" = "release-1.3" ]]; then
  ...
  export BMOBRANCH="${BMORELEASEBRANCH:-v0.3.1}"
elif [[ "${CAPM3RELEASEBRANCH}" = "release-1.5" ]]; then
...
export MINIKUBE_VERSION="${MINIKUBE_VERSION:-v1.31.2}"
export MINIKUBE_SHA256="${MINIKUBE_SHA256:-88a80c051696adaa1a2a0c6aba5fde18176fd5afa87be10617ecaab9cd3a719b}"
export MINIKUBE_DRIVER_SHA256="${MINIKUBE_DRIVER_SHA256:-8cbf5bc4b7306f44b4d9bcbbf55c26a7a866ab069f4d1365920437ed894c3a39}"
