...
export MINIKUBE_VERSION="${MINIKUBE_VERSION:-v1.31.1}"
export MINIKUBE_SHA256="ebcdfb0a520e9e746360a9dd954a9006ca75770e53fcdae493b6ac9a20026733"
export MINIKUBE_DRIVER_SHA256="1f6652ad81329e49021771bf0b1fb2cdf0869a8d41e3f2199f984c0363ca681e"

# Kind, kind node image versions (if EPHEMERAL_CLUSTER=kind)
export KIND_VERSION=${KIND_VERSION:-"v0.20.0"}
export KIND_SHA256="513a7213d6d3332dd9ef27c24dab35e5ef10a04fa27274fe1c14d8a246493ded"
