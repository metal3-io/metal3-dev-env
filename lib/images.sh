...
if [[ "${IMAGE_OS}" == "ubuntu" ]]; then 
  export IMAGE_NAME=${IMAGE_NAME:-MOHAMMED-3-UBUNTU_20.04_NODE_IMAGE_K8S_${KUBERNETES_VERSION}.qcow2}
  export IMAGE_LOCATION=${IMAGE_LOCATION:-https://artifactory.nordix.org/artifactory/metal3/images/temp}
